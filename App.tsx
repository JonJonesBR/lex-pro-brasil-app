...
import JurisprudenciaScreen from './app/screens/JurisprudenciaScreen';
import LegislacaoScreen from './app/screens/LegislacaoScreen';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Tab.Screen 
          name="Jurisprudência" 
          component={JurisprudenciaScreen} 
          options={{
